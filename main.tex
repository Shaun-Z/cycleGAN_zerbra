...
\item
  ...
  \begin{quote}
  Cross-entropy is a mathematical measure of the dissimilarity between
  two probability distributions. In the context of GANs, it is used to
  quantify the discrepancy between the probability distributions of real
  and generated data.
  \end{quote}
\item
